      ...
      <section data-aos="fade-right" >
          ...
          <section>
            <div className='contenedor-tipo'>
              <h2 className='subtitulo' data-aos="zoom-in" data-aos-duration='1000' >Mis conocimientos <FontAwesomeIcon icon={faCode}/></h2>
          ...
          <section>
            <div className='contenedor-tipo'>
              <h2 className='subtitulo' data-aos="zoom-in" data-aos-duration='1000'>Formación Académica <FontAwesomeIcon icon={faGraduationCap}/></h2>
          ...
          <section>
            <div className='contenedor-tipo'>
              <h2 className='subtitulo' data-aos="zoom-in" data-aos-duration='1000'>Mis Proyectos <FontAwesomeIcon icon={faLightbulb}/></h2>
